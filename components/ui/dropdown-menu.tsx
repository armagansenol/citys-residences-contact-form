...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-default select-none items-center rounded-sm text-sm outline-none transition-colors focus:bg-neutral-100 focus:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50",
      className
    )}
    checked={checked}
    {...props}
  >
    ...
    {/* <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
       <Checkbox className="h-4 w-4 text-bricky-brick shadow-none" /> 
       <DropdownMenuPrimitive.ItemIndicator>
        <Checkbox className="h-4 w-4 text-bricky-brick" />
        <Check className="h-4 w-4 text-bricky-brick" />
      </DropdownMenuPrimitive.ItemIndicator> 
    </span> */}
  </DropdownMenuPrimitive.CheckboxItem>
))
