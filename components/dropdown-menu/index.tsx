...
export const DropdownMenuCheckboxes = forwardRef<DropdownMenuCheckboxesRef, DropdownMenuCheckboxesProps>(
  ({ triggerText = "Open", options, defaultValues = {}, onChange, className }, ref) => {
...
DropdownMenuCheckboxes.displayName = "DropdownMenuCheckboxes"
